...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Usuário autorizado " + autorizado.toString() +  "</h1>");
        out.println("</body>");
        out.println("</html>");
        /*
        ...
        {            
            if (usu.getLogin().equals(login))
            {
                if (usu.getSenha().equals(senha))
                {
                    ...
                    out.println("</head>");
                    out.println("<body>");
                    out.println("<h1>Usuário " + usu.getLogin()+ " autorizado" + "</h1>");
                    out.println("</body>");
                    out.println("</html>");
                }else
                {
                ...
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Usuário " + usu.getLogin() + " não autorizado" + "</h1>");
                out.println("</body>");
                out.println("</html>");
                }
            }            
