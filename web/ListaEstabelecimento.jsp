                ...
                <table class="table  table-bordered table-hover">
                    ...
                    <c:forEach var="estabelecimento" items="${dao.lista}">            
                        <tr>
                            ...
                            <td class="listagem-remover"><a href="Estabelecimento.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Alterar</a></td>
                            <td class="listagem-excluir"><a href="Estabelecimento.jsp"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Remover</a></td>
                        </tr>
                    </c:forEach>                                            
                    <%----%>
                </table>
